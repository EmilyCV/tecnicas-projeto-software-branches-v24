...
import com.pece.agencia.api.core.application.service.ClienteService;
import com.pece.agencia.api.core.application.service.PacoteService;
...
public class PacoteApiDelegateImplementation implements PacoteApiDelegate {
    ...
    @Override
    public ResponseEntity<Pacote> buscarPacotePorId(UUID id) throws PacoteNaoEncontradoException {
        return ResponseEntity.ok(pacoteMapper.toDTO(pacoteService.findById(id)));
    }
