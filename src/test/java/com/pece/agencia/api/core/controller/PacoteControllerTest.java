...
class PacoteControllerTest extends AbstractTest {
        ...
        class PagedBasedTest {
            ...
            void deveListarComprasPacoteComPaginacaoPadrao(@TokenFor(username = "camila.mendes78", password = "x") String token) throws Exception {
                mockMvc.perform(get(BASE_URL + "/" + PACOTE_ID + "/compras")
                        ...
                        .andExpect(jsonPath("$[0].cliente.endereco.id").isNotEmpty())
                        ...
                        .andExpect(jsonPath("$[0].pacote.items[0].endereco.id").isNotEmpty())
    ...
    class PagedBasedTest {
        ...
        void deveListarPacotesComPaginacaoPadrao(@TokenFor(username = "camila.mendes78", password = "x") String token) throws Exception {
            mockMvc.perform(get(BASE_URL)
                    ...
                    .andExpect(jsonPath("$[0].items[1].endereco.id").isNotEmpty())
                    ...
                    .andExpect(jsonPath("$[0].custo").value(730.75))
                    .andExpect(jsonPath("$[0].valorDesconto").value(194.25))
    ...
    class SingleEntityTest {
        ...
        @Test
        @DisplayName("Deve retornar um pacote por ID e validar todos os atributos (desconto lote")
        void deveRetornarPacotePorIdRDescontoLote(@TokenFor(username = "camila.mendes78", password = "x") String token) throws Exception {
            String pacoteId = "c1d433cd-4f0c-496a-88d3-dcf4fefb50b8"; // Ajuste conforme o dataset real
            mockMvc.perform(get(BASE_URL + "/" + pacoteId)
                            .header(HttpHeaders.AUTHORIZATION, "Bearer " + token))
                    .andDo(print())
                    .andExpect(status().isOk())
                    .andExpect(jsonPath("$.id").value("c1d433cd-4f0c-496a-88d3-dcf4fefb50b8"))
                    .andExpect(jsonPath("$.nome").value("Férias em Lençóis Maranhenses"))
                    .andExpect(jsonPath("$.localidade.id").value("d9f12450-7c19-41fb-8ed7-f6828a2830cd"))
                    .andExpect(jsonPath("$.localidade.nomeCidade").value("Barreirinhas"))
                    .andExpect(jsonPath("$.localidade.estado").value("MA"))
                    .andExpect(jsonPath("$.localidade.codigoLocadoraVeiculo").value("642FA21B"))
                    .andExpect(jsonPath("$.dataInicio").value("2025-11-20"))
                    .andExpect(jsonPath("$.dataFim").value("2225-11-27"))
                    .andExpect(jsonPath("$.disponibilidade").value(6))
                    .andExpect(jsonPath("$.desconto").value(0.05))
                    .andExpect(jsonPath("$.items", hasSize(3)))
                    .andExpect(jsonPath("$.items[0].id").value("244a3402-45b5-4967-901a-d7722e8d13b6"))
                    .andExpect(jsonPath("$.items[0].type").value("HOTEL"))
                    .andExpect(jsonPath("$.items[0].preco").value(320))
                    .andExpect(jsonPath("$.items[0].nomeHotel").value("Pousada do Sossego"))
                    .andExpect(jsonPath("$.items[0].endereco.id").isNotEmpty())
                    .andExpect(jsonPath("$.items[0].endereco.cep").value("71596643"))
                    .andExpect(jsonPath("$.items[0].endereco.localidade.id").value("933243f9-4aec-4288-af69-4d6ecf0cc16b"))
                    .andExpect(jsonPath("$.items[0].endereco.localidade.nomeCidade").value("Curitiba"))
                    .andExpect(jsonPath("$.items[0].endereco.localidade.estado").value("PR"))
                    .andExpect(jsonPath("$.items[0].endereco.localidade.codigoLocadoraVeiculo").value("FEF47CEE"))
                    .andExpect(jsonPath("$.items[0].endereco.logradouro").value("Rua das Flores"))
                    .andExpect(jsonPath("$.items[0].endereco.numero").value("294"))
                    .andExpect(jsonPath("$.items[0].endereco.complemento").value("Conjunto 12"))
                    .andExpect(jsonPath("$.items[0].endereco.bairro").value("Centro"))
                    .andExpect(jsonPath("$.items[0].email").value("contato@pousadadosossego.com.br"))
                    .andExpect(jsonPath("$.items[0].telefone").value("(21) 91234-5678"))
                    .andExpect(jsonPath("$.items[0].idPlataforma").value("7901ad77"))
                    .andExpect(jsonPath("$.items[1].type").value("ALUGUEL_VEICULO"))
                    .andExpect(jsonPath("$.items[1].id").value("35a306cf-e016-43fa-a0bc-798d004dfe2f"))
                    .andExpect(jsonPath("$.items[1].preco").value(110))
                    .andExpect(jsonPath("$.items[1].nomeLocadora").value("Veloz e Seguro"))
                    .andExpect(jsonPath("$.items[1].categoriaCarro").value("Econômico"))
                    .andExpect(jsonPath("$.items[1].email").value("contato@velozeseguro.com"))
                    .andExpect(jsonPath("$.items[1].telefone").value("(51) 97890-1234"))
                    .andExpect(jsonPath("$.items[2].type").value("TRANSLADO_AEREO"))
                    .andExpect(jsonPath("$.items[2].id").value("6e973499-a351-44b6-8ef6-08dea62b21e0"))
                    .andExpect(jsonPath("$.items[2].preco").value(380))
                    .andExpect(jsonPath("$.items[2].nomeCompanhia").value("Asas Azuis"))
                    .andExpect(jsonPath("$.items[2].vooIdaNumero").value("AA5678"))
                    .andExpect(jsonPath("$.items[2].vooVoltaNumero").value("AA1234"))
                    .andExpect(jsonPath("$.items[2].vooIdaHora").value("14:15:00"))
                    .andExpect(jsonPath("$.items[2].vooVoltaHora").value("16:45:00"))
                    .andExpect(jsonPath("$.items[2].email").value("sac@asasazuis.com"))
                    .andExpect(jsonPath("$.items[2].telefone").value("(21) 91234-5678"))
                    .andExpect(jsonPath("$.duracao").value(10))
                    .andExpect(jsonPath("$.custo").value(810))
                    .andExpect(jsonPath("$.valorDesconto").value(0.0))
                    .andExpect(jsonPath("$.preco").value(810));
        }
        ...
        void deveRetornarPacotePorIdRegular(@TokenFor(username = "camila.mendes78", password = "x") String token) throws Exception {
            ...
            mockMvc.perform(get(BASE_URL + "/" + pacoteId)
                    ...
                    .andExpect(jsonPath("$.items[1].endereco.id").isNotEmpty())
                    ...
                    .andExpect(jsonPath("$.custo").value(730.75))
                    .andExpect(jsonPath("$.valorDesconto").value(194.25))
        ...
        void deveRetornarPacotePorIdNg(@TokenFor(username = "camila.mendes78", password = "x") String token) throws Exception {
            ...
            mockMvc.perform(get(BASE_URL + "/" + pacoteId)
                    ...
                    .andExpect(jsonPath("$.items[0].nomeHotel").isNotEmpty())
                    .andExpect(jsonPath("$.items[0].endereco.id").isNotEmpty())
