...
│   ├── archunit               # Anotação de meta-dados para testes de arquitetura com ArchUnit
...
├── core                       # API publica do módulo principal da aplicação
│   ├── application            # Camada de aplicações
│   │   ├── exception          # Exceções de nivel de aplicações
│   │   ├── ports              # Portas (Ports & Adapters)
│   │   └── service            # Servicos de aplicação
│   ├── domain                 # Camada de dominio
│   │   ├── exception          # Exceções de domino
│   │   ├── model              # Entidades e VOs
│   │   ├── repository         # Interfaces de acesso a dados (Spring Data JPA)
│   │   └── service            # Serviços de dominio
...
├── hotelaria                  # API para modulo de hotelaria
│   └── internal               # Classes internas do módulo de hotelaria
...
│       └── infrastruture      # Camada de Infraestrutura
│           └── adapters       # Adaptadores (Ports & Adapters)
├── pagamento                  # API para modulo de pagamento
│   └── internal               # Classes internas do módulo de pagamentos
│       └── stripe             # Classes de integração com o stripe
├           ├── config         # Configurações relativas ao stripe
│           └── infrastructure # Camada de Infraestrutura
│               └── adapters   # Adaptadores (Ports & Adapters)
├── aereo                      # Funcionalidades específicas do modulo de translado aéreo
│   └── internal               # Classes internas do módulo de translado aéreo
│       └── infrastructure     # Camada de Infraestrutura
│           └── adapters       # Adaptadores (Ports & Adapters)
...
| Usuário | Email | Grupo | Senha | Fidelizado | Percentual Desconto Máximo | Fator Desconto | Periodo        |
|---|---|---|---|---|---|----------------|----------------|
...
| joão.ferreira | joão.ferreira98@mail.com | clientes | x | ✅ | %25 | %5             | 36500 Dias |
| lucas.lima78 | lucas.lima78@mail.com | clientes | x | ✅ | 15% | 2%             | 30 Dias        |
| maria.ferreira1 | maria.ferreira1@site.com | clientes | x | ❌ | -- | --             | --             |
| pedro.castro72 | pedro.castro72@br.com | atendentes | x | ❌ | -- | --             | --             |
| pedro.nunes33 | pedro.nunes33@site.com | clientes | x | ✅ | 10% | 1,5%           | 15 Dias        |
